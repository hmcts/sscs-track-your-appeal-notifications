...
public class SubscriptionPersonalisationTest {
    ...
    public void setup() {
        ...
        newCcdResponse = new CcdResponse("1234", newAppellantSubscription, null, DWP_RESPONSE_RECEIVED);
        oldCcdResponse = new CcdResponse("5432", oldAppellantSubscription, null, DWP_RESPONSE_RECEIVED);
    }
    ...
    public void emptyOldAppellantSubscriptionReturnsFalseForSubscriptionCreatedNotificationType() {
        Boolean result = personalisation.shouldSendSmsSubscriptionConfirmation(
                newCcdResponse, new CcdResponse("5432", null, null, DWP_RESPONSE_RECEIVED));
    ...
    public void emptyNewAppellantSubscriptionReturnsFalseForSubscriptionCreatedNotificationType() {
        Boolean result = personalisation.shouldSendSmsSubscriptionConfirmation(
                new CcdResponse("1234", null, null, DWP_RESPONSE_RECEIVED), oldCcdResponse);
