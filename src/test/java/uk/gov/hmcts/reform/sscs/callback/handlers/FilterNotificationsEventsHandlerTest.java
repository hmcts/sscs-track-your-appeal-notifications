...
public class FilterNotificationsEventsHandlerTest {
    ...
    @Parameters({"ADJOURNED_NOTIFICATION", "ADMIN_APPEAL_WITHDRAWN", "APPEAL_DORMANT_NOTIFICATION",
            "APPEAL_LAPSED_NOTIFICATION", "APPEAL_RECEIVED_NOTIFICATION", "APPEAL_WITHDRAWN_NOTIFICATION",
            "DECISION_ISSUED", "DIRECTION_ISSUED", "DWP_APPEAL_LAPSED_NOTIFICATION", "DWP_RESPONSE_RECEIVED_NOTIFICATION",
            "DWP_UPLOAD_RESPONSE_NOTIFICATION", "EVIDENCE_RECEIVED_NOTIFICATION", "HEARING_BOOKED_NOTIFICATION",
            "ISSUE_FINAL_DECISION", "NON_COMPLIANT_NOTIFICATION", "POSTPONEMENT_NOTIFICATION", "REISSUE_DOCUMENT",
    ...
    @Test
    @Parameters({"DO_NOT_SEND", "SYA_APPEAL_CREATED_NOTIFICATION", "ISSUE_FINAL_DECISION"})
