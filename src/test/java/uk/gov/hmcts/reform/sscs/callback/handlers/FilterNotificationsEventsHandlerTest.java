...
public class FilterNotificationsEventsHandlerTest {
    ...
    @Test
    @Parameters({"DWP_UPLOAD_RESPONSE_NOTIFICATION", "DIRECTION_ISSUED", "VALID_APPEAL_CREATED", "NON_COMPLIANT_NOTIFICATION", "REISSUE_DOCUMENT", "STRUCK_OUT", "ISSUE_ADJOURNMENT"})
