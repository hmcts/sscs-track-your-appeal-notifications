...
public class PersonalisationFactoryTest {
    ...
    @Parameters({"APPEAL_LAPSED", "APPEAL_LAPSED", "DWP_APPEAL_LAPSED",
        ...
        "PROCESS_AUDIO_VIDEO", "PROCESS_AUDIO_VIDEO_WELSH", "POSTPONEMENT_GRANTED", "POSTPONEMENT_REFUSED",
        "ACTION_POSTPONEMENT_REQUEST_WELSH", "ISSUE_FINAL_DECISION", "ISSUE_FINAL_DECISION_WELSH",
        "ISSUE_ADJOURNMENT_NOTICE", "STRUCK_OUT", "NON_COMPLIANT", "DEATH_OF_APPELLANT", "PROVIDE_APPOINTEE_DETAILS"})
