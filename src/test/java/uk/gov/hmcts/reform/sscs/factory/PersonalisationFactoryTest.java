...
public class PersonalisationFactoryTest {
    ...
    @Parameters({"APPEAL_LAPSED", "APPEAL_LAPSED", "DWP_APPEAL_LAPSED",
        ...
        "ACTION_POSTPONEMENT_REQUEST_WELSH", "ISSUE_FINAL_DECISION", "ISSUE_FINAL_DECISION_WELSH", "ISSUE_ADJOURNMENT_NOTICE",
        "STRUCK_OUT", "NON_COMPLIANT", "DEATH_OF_APPELLANT", "PROVIDE_APPOINTEE_DETAILS"})
