...
public class CcdNotificationWrapperTest {
    ...
    @Test
    @Parameters({"SYA_APPEAL_CREATED_NOTIFICATION, cor", "ADJOURNED_NOTIFICATION, oral",
            "DWP_RESPONSE_RECEIVED_NOTIFICATION, paper", "DWP_RESPONSE_RECEIVED_NOTIFICATION, oral",
    ...
    @Test
    @Parameters({"APPEAL_LAPSED_NOTIFICATION, paper", "APPEAL_LAPSED_NOTIFICATION, oral", "EVIDENCE_REMINDER_NOTIFICATION, oral", "DWP_UPLOAD_RESPONSE_NOTIFICATION, oral"})
