...
public class CcdNotificationWrapperTest {
    ...
    @Test
    @Parameters({"APPEAL_LAPSED_NOTIFICATION","APPEAL_WITHDRAWN_NOTIFICATION","POSTPONEMENT_NOTIFICATION","HEARING_BOOKED_NOTIFICATION","APPEAL_RECEIVED_NOTIFICATION", "APPEAL_DORMANT_NOTIFICATION"})
