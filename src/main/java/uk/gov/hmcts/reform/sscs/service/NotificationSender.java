...
public class NotificationSender {
    ...
    public void sendBundledLetter(Address address, byte[] directionText, Map<String, String> personalisation, String reference, String ccdCaseId) throws NotificationClientException {
