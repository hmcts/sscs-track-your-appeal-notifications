...
public enum NotificationEventType {
    ...
    ISSUE_FINAL_DECISION(EventType.ISSUE_FINAL_DECISION, true, true, true, false, false, 60L),
    ISSUE_FINAL_DECISION_WELSH(EventType.ISSUE_FINAL_DECISION_WELSH, true, true, true, false, false, 60L),
