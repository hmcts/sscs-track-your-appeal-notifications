...
public class NotificationValidService {
    protected static final List<NotificationEventType> FALLBACK_LETTER_SUBSCRIPTION_TYPES = Arrays.asList(DWP_RESPONSE_RECEIVED_NOTIFICATION, SYA_APPEAL_CREATED_NOTIFICATION, VALID_APPEAL_CREATED, DWP_APPEAL_LAPSED_NOTIFICATION);
    ...
    protected static final List<NotificationEventType> DOCMOSIS_LETTERS = Arrays.asList(APPEAL_RECEIVED_NOTIFICATION, DIRECTION_ISSUED, DECISION_ISSUED, DWP_UPLOAD_RESPONSE_NOTIFICATION, VALID_APPEAL_CREATED);
