...
public class NotificationValidService {
    ...
    protected static final List<NotificationEventType> BUNDLED_LETTER_EVENT_TYPES = Arrays.asList(DIRECTION_ISSUED, DECISION_ISSUED, ISSUE_FINAL_DECISION, ISSUE_ADJOURNMENT_NOTICE);
    protected static final List<NotificationEventType> INTERLOC_LETTERS = Arrays.asList(DIRECTION_ISSUED, DECISION_ISSUED, ISSUE_FINAL_DECISION, REQUEST_INFO_INCOMPLETE, NON_COMPLIANT_NOTIFICATION, VALID_APPEAL_CREATED, RESEND_APPEAL_CREATED_NOTIFICATION);
    protected static final List<NotificationEventType> DOCMOSIS_LETTERS = Arrays.asList(STRUCK_OUT, APPEAL_RECEIVED_NOTIFICATION, DIRECTION_ISSUED, DECISION_ISSUED, ISSUE_FINAL_DECISION, ISSUE_ADJOURNMENT_NOTICE, DWP_UPLOAD_RESPONSE_NOTIFICATION, VALID_APPEAL_CREATED, RESEND_APPEAL_CREATED_NOTIFICATION, REQUEST_INFO_INCOMPLETE);
