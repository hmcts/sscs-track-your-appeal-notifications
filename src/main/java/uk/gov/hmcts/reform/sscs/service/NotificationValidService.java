...
public class NotificationValidService {
    ...
    protected static final List<NotificationEventType> DOCMOSIS_LETTERS = Arrays.asList(APPEAL_RECEIVED_NOTIFICATION, DIRECTION_ISSUED, DECISION_ISSUED, ISSUE_FINAL_DECISION, DWP_UPLOAD_RESPONSE_NOTIFICATION, VALID_APPEAL_CREATED, RESEND_APPEAL_CREATED_NOTIFICATION);
