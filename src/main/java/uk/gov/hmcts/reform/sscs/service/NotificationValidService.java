...
public class NotificationValidService {
    ...
    protected static final List<NotificationEventType> INTERLOC_LETTERS = Arrays.asList(DIRECTION_ISSUED, DECISION_ISSUED, REQUEST_INFO_INCOMPLETE, NON_COMPLIANT_NOTIFICATION, VALID_APPEAL_CREATED, RESEND_APPEAL_CREATED_NOTIFICATION);
    protected static final List<NotificationEventType> DOCMOSIS_LETTERS = Arrays.asList(APPEAL_RECEIVED_NOTIFICATION, DIRECTION_ISSUED, DECISION_ISSUED, DWP_UPLOAD_RESPONSE_NOTIFICATION, VALID_APPEAL_CREATED, RESEND_APPEAL_CREATED_NOTIFICATION, REQUEST_INFO_INCOMPLETE);
