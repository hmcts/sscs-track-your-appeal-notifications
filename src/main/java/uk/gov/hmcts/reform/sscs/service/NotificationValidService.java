...
public class NotificationValidService {
    ...
    protected static final List<NotificationEventType> DOCMOSIS_LETTERS = Arrays.asList(STRUCK_OUT, APPEAL_RECEIVED_NOTIFICATION, DIRECTION_ISSUED, DIRECTION_ISSUED_WELSH, DECISION_ISSUED, DECISION_ISSUED_WELSH, ISSUE_FINAL_DECISION, ISSUE_ADJOURNMENT_NOTICE, ISSUE_ADJOURNMENT_NOTICE_WELSH, DWP_UPLOAD_RESPONSE_NOTIFICATION, VALID_APPEAL_CREATED, RESEND_APPEAL_CREATED_NOTIFICATION, REQUEST_INFO_INCOMPLETE, REVIEW_CONFIDENTIALITY_REQUEST, JOINT_PARTY_ADDED, NON_COMPLIANT_NOTIFICATION, APPEAL_LAPSED_NOTIFICATION, DWP_APPEAL_LAPSED_NOTIFICATION, HMCTS_APPEAL_LAPSED_NOTIFICATION);
