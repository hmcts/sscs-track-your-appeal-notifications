...
public class NotificationValidService {
    protected static final List<NotificationEventType> FALLBACK_LETTER_SUBSCRIPTION_TYPES =
        Arrays.asList(DWP_RESPONSE_RECEIVED_NOTIFICATION, SYA_APPEAL_CREATED_NOTIFICATION, EVIDENCE_RECEIVED_NOTIFICATION,
            VALID_APPEAL_CREATED, DWP_APPEAL_LAPSED_NOTIFICATION);
    private static final List<NotificationEventType> MANDATORY_LETTER_EVENT_TYPES =
        Arrays.asList(DWP_UPLOAD_RESPONSE_NOTIFICATION, ADMIN_APPEAL_WITHDRAWN, APPEAL_WITHDRAWN_NOTIFICATION, STRUCK_OUT,
            APPEAL_RECEIVED_NOTIFICATION, HEARING_BOOKED_NOTIFICATION, DIRECTION_ISSUED, DECISION_ISSUED,
