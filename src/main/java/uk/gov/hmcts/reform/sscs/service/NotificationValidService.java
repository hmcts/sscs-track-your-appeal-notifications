...
public class NotificationValidService {
    ...
    protected static final List<NotificationEventType> BUNDLED_LETTER_EVENT_TYPES = Arrays.asList(PROCESS_AUDIO_VIDEO, PROCESS_AUDIO_VIDEO_WELSH, DIRECTION_ISSUED, DIRECTION_ISSUED_WELSH, DECISION_ISSUED, DECISION_ISSUED_WELSH, ISSUE_FINAL_DECISION, ISSUE_FINAL_DECISION_WELSH, ISSUE_ADJOURNMENT_NOTICE, ISSUE_ADJOURNMENT_NOTICE_WELSH, PROCESS_AUDIO_VIDEO, PROCESS_AUDIO_VIDEO_WELSH);
