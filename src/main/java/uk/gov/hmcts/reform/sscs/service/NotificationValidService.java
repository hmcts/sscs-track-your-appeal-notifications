...
public class NotificationValidService {
    ...
    protected static final List<NotificationEventType> INTERLOC_LETTERS = Arrays.asList(STRUCK_OUT, DIRECTION_ISSUED, REQUEST_INFO_INCOMPLETE, JUDGE_DECISION_APPEAL_TO_PROCEED, TCW_DECISION_APPEAL_TO_PROCEED, NON_COMPLIANT_NOTIFICATION);
    protected static final List<NotificationEventType> DOCMOSIS_LETTERS = Collections.singletonList(APPEAL_RECEIVED_NOTIFICATION);
