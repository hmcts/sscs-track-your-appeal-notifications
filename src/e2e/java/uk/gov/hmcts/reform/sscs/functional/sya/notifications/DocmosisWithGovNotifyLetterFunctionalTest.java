...
public class DocmosisWithGovNotifyLetterFunctionalTest extends AbstractFunctionalTest {
    ...
    @Test
    public void sendsFinalDecisionIssuedLetterToAppellantAndRepresentative() throws IOException, NotificationClientException {

        NotificationEventType notificationEventType = NotificationEventType.ISSUE_FINAL_DECISION;
    ...
    @Test
    public void sendsStruckOutLetterToAppellantAndRepresentative() throws IOException, NotificationClientException {

        NotificationEventType notificationEventType = NotificationEventType.STRUCK_OUT;
    ...
    @Test
    public void sendsReviewConfidentialityRequestLetterToAppellant() throws IOException, NotificationClientException {

        NotificationEventType notificationEventType = NotificationEventType.REVIEW_CONFIDENTIALITY_REQUEST;
